...
//
//     final specificSurah = specificSurahFromJson(jsonString);

import 'dart:convert';

SpecificSurah specificSurahFromJson(String str) =>
    SpecificSurah.fromJson(json.decode(str));

String specificSurahToJson(SpecificSurah data) => json.encode(data.toJson());
...
class SpecificSurah {
  ...
  factory SpecificSurah.fromJson(Map<String, dynamic> json) => SpecificSurah(
        code: json["code"],
        status: json["status"],
